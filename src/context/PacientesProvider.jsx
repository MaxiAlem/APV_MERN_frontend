...
export const PacientesProvider = ({children})=>{
    ...
    const eliminarPaciente =async id=>{
        const confirmar = confirm('confirmas que desas eliminar?')//nos devuelve un true false
        if(confirmar){
            try {
                const token = localStorage.getItem('token');
                const config = {
                ...
                //nos trae por el filter a todos los pacientes con el id diferentes al id del àiente elminado
